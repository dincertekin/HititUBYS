...
public class UBYS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ubys);
        ...
        navigationView.setSelectedItemId(R.id.ubys);
    ...
    public void load() {
        webView.loadUrl("https://ubys.hitit.edu.tr/");
